...
def run_regular_attack(hparams, challenge_bits, logger_name, root_folder,
    ...
    data_path = f"{tmp_folder}/results.json"
    ...
    trainer = Trainer(gpus=1, max_epochs=50, logger=False)
...
def main():
    ...
    root_folder = f"results_var_sets"
    Path(root_folder).mkdir(parents=True, exist_ok=True)

    run_regular_attack(hparams, challenge_bits, "unnamed", root_folder,
                       folder)
